    ...
    */
	...
	public function enviaGateway($order, $xml) {
		...
		if($resposta == "erro") {
			...
			Mage::throwException("Não foi possível realizar a transação. Verifique os dados preenchidos.");
			...
			if($resposta == "Em Análise"){
				...
				if ($formapagamento == "boleto") {
                    ...
                    $msg.="<a href='".$url_destino."' target='_blank'><img src='" . $url_base ."skin/frontend/base/default/akatus/images/boleto.gif' /></a>";
				...
				if ($formapagamento=="tef") {
                    ...
                    $msg.="<a href='".$url_destino."' target='_blank'><img src='" . $url_base ."/skin/frontend/base/default/akatus/images/tef.gif' /></a>";
